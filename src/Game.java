...
public class Game extends JPanel implements ActionListener, KeyListener {
    ...
    public Game() {
        ...
        ImageIcon player1Image = new ImageIcon("resources/player1.png");
        this.player1Image = player1Image.getImage();

        ImageIcon player2Image = new ImageIcon("resources/player2.png");
    ...
    private void blockSound(){
        String filename = "resources/stone" + Integer.toString(random.nextInt(8) + 1) + ".wav";
        playWav(filename);
    }

    private void coinSound(){
        playWav("resources/coin.wav");
    }
