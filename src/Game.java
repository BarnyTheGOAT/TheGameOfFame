...
public class Game extends JPanel implements ActionListener, KeyListener {
	...
	private Clip coinClip, deathClip, endgameClip;

	public Game() {
		try {
			String filename = "resources/sounds/coin.wav";
		...
		try {
			String filename = "resources/sounds/death.wav";
			File file = new File(filename);
			AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(file);
		...
		try {
			String filename = "resources/sounds/endGame.wav";
			File file = new File(filename);
			AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(file);
			endgameClip = AudioSystem.getClip();
			endgameClip.open(audioInputStream);
		} catch (Exception e) {
